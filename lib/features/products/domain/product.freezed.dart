...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, description: $description, quantity: $quantity, price: $price, scannedAt: $scannedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, description, quantity, price, scannedAt);
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      final int quantity,
      final double? price,
      final DateTime? scannedAt}) = _$ProductImpl;
